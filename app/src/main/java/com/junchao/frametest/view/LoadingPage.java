...
import com.junchao.frametest.Constants.Constants;
...
public abstract class LoadingPage extends FrameLayout {
    ...
    public int state = Constants.STATE_UNKNOWN;
    ...
    public void showPage() {
        ...
        if (state == Constants.STATE_EMPTY || state == Constants.STATE_ERROR || state == Constants.STATE_SUCCESS) {
            // 关闭动画
            stopAnimation();
        }
        ...
        if (emptyView != null) {
            emptyView.setVisibility(state == Constants.STATE_EMPTY ? View.VISIBLE : View.GONE);
        }

        if (errorView != null) {
            errorView.setVisibility(state == Constants.STATE_ERROR ? View.VISIBLE : View.GONE);
        }
